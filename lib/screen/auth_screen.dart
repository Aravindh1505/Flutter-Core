  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (error.message.contains('EMAIL_EXISTS')) {
        ...
        errorMessage = 'This password is too weak. Password should be at least 6 characters.';
      ...
      CustomWidgets.showAlertDialog(context, 'Error Occurred!', errorMessage);
    } catch (error) {
      CustomWidgets.showAlertDialog(context, 'Error Occurred!', error.message);
    }
